...
Die aufgenommen Metriken werden gegen die verwendeten Anzahl an Training samples aufgetragen. 
...
Die aufgenommen Metriken besitzen ihren maximalen Wert, bei 3404 samples und somit $\qty{100}{\%}$ des verwendete Datensatzes.
Am geringsten sind die Werte bei 340 Bildern.
Mit zunehmender Datenmenge steigen die Werte der Metriken.
Ab einer verwendet Menge von 2042 Daten nähren sich die Werte einer Sättigung.
Für die Accuracy liegt diese bei ungefähr $\qty{95}{\%}$, bei der Sensitivity bei ca. 0.93 und bei der Specificity liegt die Sättigung bei ungefähr 0.98. 
